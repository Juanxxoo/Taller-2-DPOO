...
public class SandboxConjuntos
{
    ...
    {
    	arbolCadenas = arbolCadenas.stream().map(String::toUpperCase).collect(Collectors.toCollection(TreeSet::new));    
    }
    ...
    {
    	TreeSet<String> inversa = new TreeSet<>(Comparator.reverseOrder());
        inversa.addAll(arbolCadenas);
